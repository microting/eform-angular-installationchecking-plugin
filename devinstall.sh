...
if [ -d "Documents/workspace/microting/eform-angular-frontend/eform-client/src/app/plugins/modules/installationchecking-pn" ]; then
...
if [ -d "Documents/workspace/microting/eform-angular-frontend/eFormAPI/Plugins/InstallationChecking.Pn" ]; then

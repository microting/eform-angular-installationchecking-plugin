...
if [ -d "/var/www/microting/eform-angular-frontend/eform-client/src/app/plugins/modules/items-installationchecking-pn"]; then
	su ubuntu -c \
	"rm -fR /var/www/microting/eform-angular-frontend/eform-client/src/app/plugins/modules/items-installationchecking-pn"
fi

su ubuntu -c \
"cp -av /var/www/microting/eform-angular-installationchecking-plugin/eform-client/src/app/plugins/modules/items-installationchecking-pn /var/www/microting/eform-angular-frontend/eform-client/src/app/plugins/modules/items-installationchecking-pn"
su ubuntu -c \
...
su ubuntu -c \
"cp -av /var/www/microting/eform-angular-installationchecking-plugin/eFormAPI/Plugins/InstallationChecking.Pn/InstallationChecking.Pn/out /var/www/microting/eform-angular-frontend/eFormAPI/eFormAPI.Web/out/Plugins/TrashInspection"
